...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_LSHIFT,      KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                                                           KC_H,           KC_J,           KC_K,           KC_L,           KC_SCOLON,      KC_RSHIFT,
    MT(MOD_LCTL, KC_TAB),KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           KC_DOWN,                                        KC_UP,          KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       MT(MOD_RCTL, KC_ENTER),
    LT(1,KC_GRAVE), WEBUSB_PAIR,    KC_TRANSPARENT, KC_GRAVE,       KC_QUOTE,                                                                                                       KC_SPACE,       KC_TRANSPARENT, KC_LBRACKET,    KC_RBRACKET,    MO(1),
                                                                                                    KC_LALT,        KC_LGUI,        KC_TRANSPARENT, MT(MOD_LCTL, KC_ESCAPE),
                                                                                                                    KC_HOME,        KC_PGUP,
                                                                                    KC_BSPACE,      MT(MOD_LGUI, KC_ESCAPE),KC_END,         KC_PGDOWN,      KC_ENTER,       KC_SPACE
  ),
