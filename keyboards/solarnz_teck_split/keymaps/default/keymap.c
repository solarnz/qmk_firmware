...
[_BASE] = LAYOUT(
  ...
  KC_BSLS,  KC_SLSH,  KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_MPRV,  /* | split | */   KC_PSCR,  KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,
            KC_LSFT,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_MNXT,  /* | split | */   KC_MPLY,  KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_RSFT,
