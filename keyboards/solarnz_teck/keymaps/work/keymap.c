...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MA] = LAYOUT(
        ...
        KC_NO,     KC_ESC,    KC_BSLS,   KC_NO,     KC_NO,     KC_NO,     MO(_FN),   KC_NUM,    KC_NO,     KC_NO,     KC_NO,     KC_EQL,    KC_RBRC, \
        ...
        KC_TAB,    KC_Z,      KC_X,      KC_C,      KC_V,      KC_B,      KC_RCTL,   KC_N,      KC_M,      KC_COMM,   KC_DOT,    KC_QUOT,   KC_ENT, \
        KC_LCTL,   KC_HOME,   KC_PGDN,   KC_PGUP,   KC_END,    KC_BSPC,   KC_LGUI,   KC_SPC,    KC_LEFT,   KC_DOWN,   KC_UP,     KC_RIGHT,  KC_RALT \
    ),
    /* 1: first FN layer */
    [_FN] = LAYOUT(
